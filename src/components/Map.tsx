...
const Map = () => {
  return (
    ...
    <div className="Form-container md:h-[450px] xl:h-[480px] md:w-[30vw] w-[90vw] max-h- relative px-4 md:px-8 py-2 md:absolute md:right-20 bg-[#FFFFFF] rounded-2xl z-10">
        <div>
