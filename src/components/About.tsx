        ...
        <div className="flex flex-col md:flex-row md:gap-5 gap-2 max-w-7xl mx-auto">
            <div className="left flex flex-col aspect-square md:gap-5 gap-2 md:w-[50%]">
                <div className="top bg-[#1E5AA0] text-white rounded-3xl md:rounded-4xl p-4 md:p-4 relative md:h-[50%]">
                    ...
                    <button className="bg-[#E5EDF9] rounded-full absolute bottom-4 md:bottom-8 right-4 md:right-8 h-8 md:h-10 aspect-square text-[#284368] flex justify-center items-center"><ArrowRight className="h-4 md:h-8" /></button>

                </div>
                <div className="bottom flex md:gap-7 gap-2 md:h-[50%]">
