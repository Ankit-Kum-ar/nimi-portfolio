  ...
  return (
    <section className="bg-[#90BAE9]/80 w-full relative pt-10">
        <div className="flex w-11/12 mx-auto justify-between items-center">
            <div className="flex w-3/12 text-[#1A4272] font-poppins text-5xl font-semibold z-20">
                Our Excellent Services
            </div>
            <div className="flex w-6/12 text-[#1B4C89] font-poppins text-lg font-medium leading-9">
        ...
        <div className="absolute z-10 w-9/12 left-10 top-30">
            <img src={nimi} alt="NIMI" />
        </div>
        <div className="flex justify-center items-center gap-10 px-4 mt-10 w-11/12 mx-auto">
